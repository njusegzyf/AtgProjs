...
(JNIEnv *env, jobject, jdouble a, jdouble b, jstring pathFile) {
  ...
  {
    bFile<<"node2@benchmark81\n";
    printf("Solved 81");
  }
  bFile<<"node3@benchmark81\n";
  return;
}
 ...
 * Signature: (DDDDDDLjava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_cn_nju_seg_atg_callCPP_CallCPP_callBenchmark69(JNIEnv *env, jobject,
    jdouble x, jdouble y, jdouble z, jdouble w, jdouble t, jdouble v,
    jstring pathFile) {
