...
public class LineChart {
  ...
  public void showLineChart(String title, List<Coodinate> coodinateList, List<Double> markerList, double effectiveValue) {
    LineChart.createLineChart(title, this.createDataset(coodinateList), markerList, effectiveValue);
  }
   ...
   * @param dataset
   */
  private static void createLineChart(String title, XYDataset dataset, List<Double> markerList, double effectiveValue) {
    JFreeChart chart = ChartFactory.createXYLineChart(title,	// 图表标题
                                                      "X",	// X轴的显示标签
                                                      "Y",	// Y轴的显示标签
    ...
    LineChart.setMarker(markerList, effectiveValue, plot);	// 设置标记线
   ...
   * @param markerList
   */
  private static void setMarker(List<Double> markerList, double effectiveValue, XYPlot plot) {
    // 建构单个特殊间隔标记
